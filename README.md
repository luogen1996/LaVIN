...
## News 
- **`2023/06/22`**: 🔥8-bit and 4-bit trainings are available now ! LaVIN-13B can be trained on a single 3090 GPU, taking around 12G GPU memory. Try it now !
