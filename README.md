...
## News 
- **`2023/06/30`**: 🔥🔥🔥 With very limited training data and cost, LaVIN achieves 3-th place on MME benchmark， outperforming seven existing multimodal LLMs. Evaluation codes are available. 
