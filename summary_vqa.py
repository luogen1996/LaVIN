...
def Eval_VQA(result_file):
    ...
    vqa_result = vqa.loadRes(resFile=result_file, quesFile=ques_file_path)
    vqa_scorer = VQAEval(vqa, vqa_result, n=2)
    vqa_scorer.evaluate()

    print("\n")
    print("Overall Accuracy is: %.02f\n" % (vqa_scorer.accuracy['overall']))
    # print("Per Question Type Accuracy is the following:")
    # for quesType in vqaEval.accuracy['perQuestionType']:
    #     print("%s : %.02f" % (quesType, vqaEval.accuracy['perQuestionType'][quesType]))
    # print("\n")
    print("Per Answer Type Accuracy is the following:")
    for ansType in vqa_scorer.accuracy['perAnswerType']:
        print("%s : %.02f" % (ansType, vqa_scorer.accuracy['perAnswerType'][ansType]))
    print("\n")

    return vqa_scorer.accuracy['overall']

Eval_VQA('./vqa_preds.json')